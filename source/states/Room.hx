...
class Room extends FlxTransitionableState
{
			...
			for (instance in instances.nodes.instance)
			{
				switch (instance.att.objName)
				{
					case 'mainchara':
						...
						// Adjust the hitbox.
						chara.setSize(chara.width * 0.5, chara.height * 0.5);
						chara.centerOffsets();
						chara.centerOrigin();
	...
	override function update(elapsed:Float):Void
	{
		...
		if (chara != null)
		{
			FlxG.collide(chara, objects, function(obj1:MainChara, obj2:FlxTypedGroup<Object>):Void
			{
